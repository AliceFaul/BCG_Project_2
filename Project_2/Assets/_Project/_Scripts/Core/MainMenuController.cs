...
namespace _Project._Scripts.Core
{
    public class MainMenuController : MonoBehaviour
    {
        ...
        List<AsyncOperation> _sceneToLoad = new List<AsyncOperation>();
        ...
        public void StartGame()
        {
            ...
            _sceneToLoad.Add(SceneManager.LoadSceneAsync(_persistentScene));
            _sceneToLoad.Add(SceneManager.LoadSceneAsync(_startBiomeScene, LoadSceneMode.Additive));
        }
